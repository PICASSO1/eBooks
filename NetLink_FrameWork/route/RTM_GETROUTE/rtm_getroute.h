#ifndef _RTM_GETROUTE_H_
#define	_RTM_GETROUTE_H_
...
#include <arpa/inet.h>
#include <linux/lwtunnel.h>     /* for RTA_ENCAP_TYPE */
...
void parse_address_type(unsigned char);

void parse_routing_protocol(unsigned char);
...
static const struct origin_map rtm_route_origin_map[] = {
...
void parse_route_origin(unsigned char);
...
static const struct type_map rtm_route_type_map[] = {
	{ RTN_UNSPEC,      "Unknown route type" },
	{ RTN_UNICAST,     "Gateway or direct route" },
	{ RTN_LOCAL,       "Local interface route" },
...
void parse_route_type(unsigned char);

void parse_rta_attributes(struct rtattr *, unsigned char);

void print_hex(const unsigned char *, size_t);
void print_ip_address(const void *, __u8);

#endif	/* _RTM_GETROUTE_H_ */
